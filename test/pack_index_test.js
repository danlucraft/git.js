...
exports.PackIndexHelpers = {
  "assertVersion": function(test) {
    test.equal(JsGit.PackIndex.assertVersion([1,1,1,1,0,0,0,2,1,1,1,1], 2), true)
    test.equal(JsGit.PackIndex.assertVersion([1,1,1,1,0,0,0,2,1,1,1,1], 3), false)
    test.equal(JsGit.PackIndex.assertVersion([1,1,1,1,0,0,0,3,1,1,1,1], 1), false)
    test.done()
  }
}
