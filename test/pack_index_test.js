var utils = require('../lib/git/utils')
  , PackIndex = require('../lib/git/pack_index')
...
exports.PackIndexHelpers = {
  "assertVersion": function(test) {
    test.equal(PackIndex.assertVersion([1,1,1,1,0,0,0,2,1,1,1,1], 2), true)
    test.equal(PackIndex.assertVersion([1,1,1,1,0,0,0,2,1,1,1,1], 3), false)
    test.equal(PackIndex.assertVersion([1,1,1,1,0,0,0,3,1,1,1,1], 1), false)
    test.done()
  }
}
