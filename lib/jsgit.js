...
JsGit = {
  ...
  // Creates a parser for the response to /git-upload-pack, which contains some
  ...
  // Creates a parser for a pack file. Pack files are used for more than just
  ...
  packFileParserFor: function(binary) {
    ...
    if (Array.isArray(binary)) {
      binaryString = JsGit.bytesToString(binary)
    }
    else {
      binaryString = binary;
    }
