...
JsGit.Remote = function(repo, name, repoUrl) {
  ...
  that.fetchRefsSmart = function(callback) {
    $.get(
    ...
    $.ajax({
      ...
      success: function(data, textStatus, xhr) {
        ...
        for (i = 0; i < objectDatas.length; i++) {
          ...
          var newObject = that.repo.addObject(object.sha, object.type, object.data)
...
JsGit.Remote.parseInfoRefs = function(data) {
  var lines = data.split("\n")
  var refs = {}
