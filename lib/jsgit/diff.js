...
JsGit.Diff = function(file1, file2, options) {
  ...
  this.toInfo = function() {
    ...
    _(this.diffChunks).each(function(chunk) {
      ...
      var infoChunk = {offset: added.offset + 1, lines:[]}
    ...
    _(this.info).each(function(chunk) {
      ...
      _(chunk.lines).each(function(line) {
        if (line.type == "context") {
          str.push("<pre class='context'>" + line.oldIndex.toString().rjust(2, " ") + " " + line.newIndex.toString().rjust(2, " ") + "  " + line.line + "</pre>")
        } else if (line.type == "added") {
          str.push("<pre class='added'>" + "   " + line.newIndex.toString().rjust(2, " ") + " +" + line.line + "</pre>")
        } else if (line.type == "removed") {
          str.push("<pre class='removed'>" + line.oldIndex.toString().rjust(2, " ") + "    -" + line.line + "</pre>")
