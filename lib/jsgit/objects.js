...
JsGit.objects = {
  CONSTRUCTOR_NAMES:{"blob": "Blob", "tree": "Tree", "commit": "Commit", "tag": "Tag", "tag ": "Tag"},
  ...
  Tree: function(sha, data) {
    ...
    var matchMode = function() {
      var first = collectUntil(JsGit.stringToBytes(" ")[0])
      if (!first) return null
      if (first != "100644" && first != "40000") {
        first = collectUntil(JsGit.stringToBytes(" ")[0])
      }
      return first
    }
