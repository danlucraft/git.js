var Diff = require('../../vendor/diff')
  ...
  , utils = require('./utils')
  ;
var FileDiff = function(file1, file2, options) {
  this.file1 = file1
  this.file2 = file2
...
FileDiff.prototype.toString = function() {
  return '<FileDiff>'
}

FileDiff.prototype.toHtml = function() {
  var str = []
  str.push("  <div class='diff'>")
  var diff = this
  _(this.info).each(function(chunk) {
    _(chunk.lines).each(function(line) {
      var truncatedLine = utils.escapeHTML(line.line.slice(0, FileDiff.MAX_LINE_CHARS))
...
FileDiff.prototype.stat = function() {
...
FileDiff.prototype.toInfo = function() {
  if (this.file1 === "") {
