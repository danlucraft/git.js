...
RepoViewer = {
  ...
  displayCommitDiff: function(commit) {
    ...
    str += "<tr><td>Committer</td><td>" + commit.committer + "</td></tr>"
    str += "<tr><td>Author</td><td>" + commit.author + "</td></tr>"
    str += "<tr><td>Message</td><td>" + commit.message + "</td></tr>"
    str += "<tr><td>Committed</td><td>" + commit.dateCommitted.toUTCString() + "</td></tr>"
    str += "<tr><td>Authored</td><td>" + commit.dateAuthored.toUTCString() + "</td></tr>"
  ...
  displayCommit: function(commit) {
    if ($("#commit-" + commit.sha).length == 0) {
      ...
      row += "<td>" + commit.dateCommitted.toUTCString() + "</td>"
      row += "</tr>"
